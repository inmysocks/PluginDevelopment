...
sed --in-place="out.bak" "s/$ORIGINAL1/$NEW1/g" $(pwd)/TiddlyWiki5/core/modules/commands/makelibrary.js
sed --in-place="out.bak" "s/$ORIGINAL2/$NEW2/g" $(pwd)/TiddlyWiki5/core/modules/commands/makelibrary.js
sed --in-place="out.bak" "s/$ORIGINAL3/$NEW3/g" $(pwd)/TiddlyWiki5/core/modules/commands/makelibrary.js
